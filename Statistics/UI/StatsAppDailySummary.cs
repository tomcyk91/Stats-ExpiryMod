...
namespace StatisticMod
{
    ...
    public partial class StatsAppManager
    {
        ...
        {
            return Plugin.Money(value, 2, true);
        }
            ...
            Color accent)
        {
            ...
            // Każda karta PODSUMOWANIA/KLIENTÓW/KAS korzysta z tego samego buildera,
            // więc jeden punkt wystarcza, aby tooltipy działały w całym module KPI.
            AttachDailySummaryCardTooltips(card, titleTMP, detailsTMP, title);
