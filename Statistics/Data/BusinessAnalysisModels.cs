...
namespace StatisticMod
{
    ...
    public sealed class ProductBusinessAnalysisRow
    {
        ...
        // Prognoza popytu. ForecastDailyVisible korzysta z tego samego modelu,
        // który służy do wyliczania pokrycia i rekomendacji zatowarowania:
        // 65% średniej z ostatnich 3 dni + 35% średniej z ostatnich 14 dni.
        public float ForecastDailyVisible;
        public float Forecast3DayVisible;
