...
namespace StatisticMod
{
    public static class BusinessAnalysisStore
    {
        ...
        public static void TickPath()
        {
            ...
            // Never persist pending analysis merely because the active save slot
            // changed. Unsaved game progress must not survive in statistics.
        ...
        {
            // Compatibility no-op. Statistics are persisted only by an actual
            // game save/QuickSave or by the completed-day commit in StatsRunner.
        }
