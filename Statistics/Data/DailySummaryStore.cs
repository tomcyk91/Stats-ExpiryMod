...
namespace StatisticMod
{
    ...
    public static class DailySummaryStore
    {
        ...
        public static void TickPath()
        {
            ...
            // A slot/path switch is not a commit. Reload the last committed
            // summary state for the newly active save instead.
        ...
        {
            // Explicit reload discards uncommitted runtime data.
            _activePath = ResolvePath();
            LoadInternal(_activePath);
        }
